...
urlpatterns = [
    ...
    path('showbuy/', views.show_buy, name='show-buy'),
    ...
    path('topwear/', views.topwearView, name='top-wear'),
    path('topwear/<slug:data>', views.topwearView, name='top-wear'),
    path('bottomwear/', views.bottomwearView, name='bottom-wear'),
    path('bottompwear/<slug:data>', views.bottomwearView, name='bottom-wear'),
